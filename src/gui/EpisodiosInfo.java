...
public class EpisodiosInfo extends JFrame{
	...
	JButton bAñadirActor= new JButton("ADD ACT/PER TO EPI");
	...
	public EpisodiosInfo(Episodio epi, AdminController controller2, long idSeriev) {
		...
		bAñadirActor.setBounds(800, 300, 250, 30);
		panel.add(bAñadirActor);
		panel.add(lSelAct);
		panel.add(lSelPer);
		panel.add(lTitulo);
		panel.add(comboAct);
	...
	public void actionInfo2(){
		...
		bAñadirActor.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
